...
class OverheidIO extends Rdw implements RdwApi
{
    ...
    final public function fetch():string|array
    {
        ...
        // hybrid
        $response = json_decode('{"jaar_laatste_registratie_tellerstand":2025,"aantal_cilinders":4,"zuinigheidsclassificatie":"A","typegoedkeuringsnummer":"e11*2007\/46*0152*02",":updated_at":"2025-02-10T21:02:17.844Z","datum_eerste_toelating":"2012-08-15","eerste_kleur":"BLAUW","datum_eerste_tenaamstelling_in_nederland":"2012-08-15","code_toelichting_tellerstandoordeel":"00","volgnummer_wijziging_eu_typegoedkeuring":0,"europese_voertuigcategorie":"M1","type":"XP13M(A)","export_indicator":false,"wam_verzekerd":true,":created_at":"2024-05-28T11:41:18.407Z",":id":"row-bd93~2t6p.k4jg","cilinderinhoud":1497,"kenteken":"25XTZ5","variant":"NHP13(MH)","vervaldatum_apk":"2025-01-27","toegestane_maximum_massa_voertuig":1565,"brandstof":[{"brandstofverbruik_gecombineerd":3.5,"geluidsniveau_stationair":74,"klasse_hybride_elektrisch_voertuig":"NOVC-HEV","brandstofverbruik_stad":3.1,":updated_at":"2025-01-21T14:48:38.495Z",":created_at":"2025-01-21T14:48:38.495Z","brandstof_volgnummer":1,"emissiecode_omschrijving":"5","nettomaximumvermogen":55,"brandstof_omschrijving":"Benzine","uitlaatemissieniveau":"EURO 5 J",":id":"row-37ha~ktkp_9rg8","co2_uitstoot_gecombineerd":79,"brandstofverbruik_buiten":"3.50","toerental_geluidsniveau":2500,"milieuklasse_eg_goedkeuring_licht":"715\/2007*566\/2011J"},{":created_at":"2025-01-21T14:48:38.495Z","brandstof_volgnummer":2,"emissiecode_omschrijving":"Z","klasse_hybride_elektrisch_voertuig":"NOVC-HEV","nominaal_continu_maximumvermogen":10.1,"brandstof_omschrijving":"Elektriciteit","uitlaatemissieniveau":"EURO 5 J",":id":"row-4i6p_nuif_38g9",":updated_at":"2025-01-21T14:48:38.495Z","milieuklasse_eg_goedkeuring_licht":"715\/2007*566\/2011J"}],"merk":"TOYOTA","kentekenplaat":"25-XTZ-5","carrosserie":[{"carrosserie_volgnummer":1,"carrosserietype":"AF","type_carrosserie_europese_omschrijving":"Multipurpose vehicle (MPV)"}],"uitvoering":"NHP130L-CHXNBW(1C)","taxi_indicator":false,"tellerstandoordeel":"Logisch","openstaande_terugroepactie_indicator":false,"aantal_zitplaatsen":5,"lengte":391,"technische_max_massa_voertuig":1565,"voertuigsoort":"Personenauto","catalogusprijs":19520,"handelsbenaming":"TOYOTA YARIS HYBRID","as":[{"wettelijk_toegestane_maximum_aslast":895,"technisch_toegestane_maximum_aslast":895,"aantal_assen":2,"as_nummer":1,"spoorbreedte":149},{"wettelijk_toegestane_maximum_aslast":825,"technisch_toegestane_maximum_aslast":825,"aantal_assen":2,"as_nummer":2,"spoorbreedte":147}],"massa_rijklaar":1160,"plaats_chassisnummer":"r. voorzitting","inrichting":"MPV","vermogen_massarijklaar":0.01,"aantal_wielen":4,"datum_tenaamstelling":"2025-01-10","massa_ledig_voertuig":1060,"tenaamstellen_mogelijk":true,"wielbasis":251,"sidecode":7,"aantal_deuren":4,"_links":{"self":{"href":"\/voertuiggegevens\/25XTZ5"}}}',true);
...
//            }, ARRAY_FILTER_USE_KEY);
            ...
            // Remove specific overheid.io data-fields
            $this->result[$endpoint->name] = $this->removeTags($result[$endpoint->name]);
        }
     ...
     * @return array
     */
    final protected function removeTags(array $array): array
    {
        $result = [];
        foreach ($array as $key => $value) {
            if (is_array($value)) {
                $result[$key] = $this->removeTags($value);
            }
            elseif (substr($key, 0, 1) !== ":" && $key !== "_links") {
                $result[$key] = $value;
            }
        }
        return $result;
